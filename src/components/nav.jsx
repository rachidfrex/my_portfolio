...
function Nav() {
  ...
  return (
        ...
        <div
        className='flex z-10 fixed md:max-w-7xl top-5 w-full bg-white/5 backdrop-blur-sm sm:p-2 justify-center items-center '
        >
        ...
        <div className='flex  mr-10 sm:mr-auto absolute right-[5%] justify-center items-center p-2 gap-2'>
            {active ? (
