...
const Bentogrids = () => {
    return (
        <div
            className='max-w-7xl  px-4 lg:mx-auto w-full h-screen flex justify-center   items-center'
        >
            <div
            ...
            >
                ...
                <div className='bg-indigo-200 col-span-4  row-span-1 lg:col-span-1 lg:row-span-2 rounded-3xl flex justify-center items-center'>
                    colomn 3
                </div>
